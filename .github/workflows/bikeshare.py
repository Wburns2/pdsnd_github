...
# load data file into a dataframe
    ...
    if month != 'all':
        ...
        month = next((index + 1 for index, m in enumerate(months) if m.lower() == month.lower()), None)
...
def display_data(df):
    """Displays 5 lines of raw data at the time when yes is selected."""
    d = 1
    while True:
        displaydata = input('\nWould you like to see 5 lines of data displayed? Enter yes or no. \n')
